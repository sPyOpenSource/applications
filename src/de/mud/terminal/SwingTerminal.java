 ...
 *
 * @version $Id: SwingTerminal.java,v 1.1 2008/05/28 00:01:46 mviara Exp $
...
public class SwingTerminal extends Component
  ...
  private final static int COLOR_FG_STD = 0;
  private final static int COLOR_BG_STD = 7;
  ...
  public SwingTerminal(VDUBuffer buffer, Font font) {
    ...
    //if (version.startsWith("1.5")) {
      try {
        ...
        SwingTerminal.class.getMethod("setFocusable", params).invoke(this, new Object[]{true});
        SwingTerminal.class.getMethod("setFocusTraversalKeysEnabled", params).invoke(this, new Object[]{false});
    ...
    cursorColorFG = Color.green;
    cursorColorBG = Color.black;
