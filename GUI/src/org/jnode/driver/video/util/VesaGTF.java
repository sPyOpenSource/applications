...
public class VesaGTF {
    ...
    private final int hFrameLength;
    ...
    private final int vFrameLength;

    private final double pixelClock;

    private final double hFrequency;

    private final double vFrequency;
