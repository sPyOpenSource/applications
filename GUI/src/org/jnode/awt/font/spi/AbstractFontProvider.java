...
public abstract class AbstractFontProvider<F extends Font, FD> implements FontProvider<F> {
     ...
     */
    private final HashMap<Font, TextRenderer> renderers = new HashMap<>();
    
    /**
     * Cache font metrics
     */
    private final HashMap<Font, FontMetrics> metrics = new HashMap<>();
    
    /**
     * All loaded fonts (name, Font)
     */
    private final HashMap<String, F> fontsByName = new HashMap<>();
    ...
    private final List<FD> userFontDatas = new Vector<>();

    private Map<FD, Size> maxCharBounds = new HashMap<>(); 
