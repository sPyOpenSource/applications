...
public class Desktop implements Runnable {
    ...
    public void run() {
        SwingUtilities.invokeLater(() -> {
            ...
            taskBar.startButton.addActionListener((ActionEvent event) -> {
            ...
            taskBar.quitMI.addActionListener((ActionEvent e) -> {
                taskBar.startMenu.setVisible(false);
                JNodeToolkit.setExitAction(null);
                JNodeToolkit.stopGui();
            });
            
            taskBar.haltMI.addActionListener((ActionEvent e) -> {
                JNodeToolkit.setExitAction(() -> {
                    VmSystem.halt(false);
                });
                JNodeToolkit.stopGui();
            });
            
            taskBar.restartMI.addActionListener((ActionEvent e) -> {
                JNodeToolkit.setExitAction(() -> {
                    VmSystem.halt(true);
                });
                JNodeToolkit.stopGui();
