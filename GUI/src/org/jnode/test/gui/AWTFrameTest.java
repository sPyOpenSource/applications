...
public class AWTFrameTest {
    public static void main(String[] args) {
        ...
        ActionListener close = (ActionEvent event) -> {
            System.exit(0);
        };

        Button show = new Button("show");
        show.addActionListener((ActionEvent event) -> {
            f2.setVisible(true);
        });
        //f.add(show);
        Button hide = new Button("hide");
        hide.addActionListener((ActionEvent event) -> {
            f2.setVisible(false);
        });
        //f.add(hide);
        ...
        front.addActionListener((ActionEvent event) -> {
            f2.toFront();
        });
        //f.add(front);
        ...
        show_mi.addActionListener((ActionEvent event) -> {
            f2.setVisible(true);
        });
        window.add(show_mi);
        MenuItem hide_mi = new MenuItem("hide");
        hide_mi.addActionListener((ActionEvent event) -> {
            f2.setVisible(false);
        });
        window.add(hide_mi);
        MenuItem back_mi = new MenuItem("back");
        back_mi.addActionListener((ActionEvent event) -> {
            f2.toBack();
        });
        window.add(back_mi);
        MenuItem front_mi = new MenuItem("front");
        front_mi.addActionListener((ActionEvent event) -> {
            f2.toFront();
        });
        window.add(front_mi);
        window.addSeparator();
        ...
        p_show_mi.addActionListener((ActionEvent event) -> {
            f2.setVisible(true);
        });
        p_window.add(p_show_mi);
        MenuItem p_hide_mi = new MenuItem("hide");
        p_hide_mi.addActionListener((ActionEvent event) -> {
            f2.setVisible(false);
        });
        p_window.add(p_hide_mi);
        MenuItem p_back_mi = new MenuItem("back");
        p_back_mi.addActionListener((ActionEvent event) -> {
            f2.toBack();
        });
        p_window.add(p_back_mi);
        MenuItem p_front_mi = new MenuItem("front");
        p_front_mi.addActionListener((ActionEvent event) -> {
            f2.toFront();
        });
