...
public abstract class AWTEvent extends java.util.EventObject
{
  ...
  protected int id;
    ...
    /* @ Marco Winter
     * Alle folgenden Konstanten sind eigentlich longs, wurden aber
     * durch ints ersetzt !
     */
  ...
  */
  ...
  public static final int INPUT_METHOD_EVENT_MASK = 1 << 11;

  /* Additional event selection masks from JDK 1.3 javadocs */
  public static final int PAINT_EVENT_MASK            = 1 << 13,
