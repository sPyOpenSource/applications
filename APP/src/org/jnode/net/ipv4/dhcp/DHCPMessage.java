...
public class DHCPMessage {
    ...
    public static final int SIZE = BOOTPFormat.SIZE + OPTIONS_SIZE;
    ...
    private final BOOTPFormat header;
     ...
     */
    private DHCPMessage(BOOTPFormat hdr) {
        header = hdr;
    }

    public DHCPMessage(BOOTPFormat hdr, int msgType) {
        this(hdr);
        messageType = msgType;
    }
