...
public interface PageStrategy {
     ...
     */
    public PageStrategyRecord fix(int iPageNum);
     ...
     */
    public void unfix(int iPageNum);
     ...
     */
    public void setDirty(int iPageNum);
     ...
     */
    public void pageIn(int iPageNum, byte[] baPage);
     ...
     * @return {@link PageStrategyRecord }, that contains the information about the page, managed by the {@link PageStrategy}.
     */
    public PageStrategyRecord pageOut(int iPageNum);
     ...
     */
    public void copy(PageStrategy cDest);
