 ...
 */
public interface Node extends jx.zero.Portal {
     ...
     * @exception NoDirectoryInodeException falls es sich nicht um ein Verzeichnis handelt
     */
    boolean isOverlayed(String name);
    ...
    void setLastModified(int time);
    void setLastAccessed(int time);
     ...
     * @exception NoDirectoryInodeException falls es sich nicht um ein Verzeichnis handelt
     */
    String[]  readdirNames() throws Exception;
