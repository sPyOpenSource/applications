...
public class WeaponDragon extends Weapon {
	...
	Missile msl = new Missile(srcActor, muzzlePosition, tgt.centerPosition(), (EntityActor) tgt.getTargetEntity(), WeaponDragon.TEXTURE_WIDTH, WeaponDragon.TEXTURE_HEIGHT, WeaponDragon.MISSILE_ANGLE,
		WeaponDragon.MISSILE_TEXTURE, this, WeaponDragon.PROJECTILE_SPEED, WeaponDragon.NUM_FACINGS, WeaponDragon.ROT, WeaponDragon.INACCURACY);
	...
	msl.jammable = false;
	msl.rangeLimit = WeaponDragon.RANGE_LIMIT;
