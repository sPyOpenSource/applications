...
public class WeaponMammothTusk extends Weapon {
	...
	Missile msl = new Missile(srcActor, muzzlePosition, tgt.centerPosition(), (EntityActor) tgt.getTargetEntity(), WeaponMammothTusk.TEXTURE_WIDTH, WeaponMammothTusk.TEXTURE_HEIGHT, WeaponMammothTusk.MISSILE_ANGLE,
		WeaponMammothTusk.MISSILE_TEXTURE, this, WeaponMammothTusk.PROJECTILE_SPEED, WeaponMammothTusk.NUM_FACINGS, WeaponMammothTusk.ROT, WeaponMammothTusk.INACCURACY);

	msl.rangeLimit = RANGE_LIMIT;
	msl.high = WeaponMammothTusk.HIGH;
