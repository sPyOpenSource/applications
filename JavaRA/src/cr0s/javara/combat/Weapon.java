...
public abstract class Weapon {
    ...
    public ArrayList<TargetType> validTargets = new ArrayList<>();
    public TreeSet<TargetType> invalidTargets = new TreeSet<>();
	...
	if (t.isEntityTarget()) {
	    ...
	    if (!GUI.getInstance().getWorld().getMap().isInMap(t.getTargetCell())) {
		return false;
	    }
	    
	    return this.isValidAgainst(t.getTargetCell().getCellPos(), GUI.getInstance().getWorld());
	}
