...
public class DropResources extends Activity {
	...
	this.waitingTicks = DropResources.WAITING_TICKS_PER_RESOURCE * harv.getCapacity();
    }
	...
	if (harv.currentFacing != EntityProc.HARV_FACING) {
	    Turn turnActivity = new Turn(harv, EntityProc.HARV_FACING, 1);
