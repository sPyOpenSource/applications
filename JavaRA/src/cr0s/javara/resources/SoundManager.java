...
public class SoundManager {
	...
	Rectangle viewportRect = null;//GUI.getInstance().getCamera().viewportRect;
	...
	listenerX = -GUI.getInstance().getCamera().getTranslateX() + GUI.getInstance().getContainer().getWidth() / 2;
	listenerY = -GUI.getInstance().getCamera().getTranslateY() + GUI.getInstance().getContainer().getHeight() / 2;
