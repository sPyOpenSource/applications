...
public class MapEntity {
    ...
    private final ShpTexture texture;
    private final String footprintString;
	...
	this.width = Integer.parseInt(dimensions.substring(0, dimensions.indexOf(",")));
	this.height = Integer.parseInt(dimensions.substring(dimensions.indexOf(",") + 1));
