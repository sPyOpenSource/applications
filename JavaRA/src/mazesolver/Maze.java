...
public class Maze {
    ...
    public void setStart(Pos start, int max){
        ...
        while (startPoint == null || !isNode(startPoint)){
            startPoint = new Pos(
                    start.getCellX() + World.random.nextInt(5) - 2, 
                    start.getCellY() + World.random.nextInt(5) - 2);
    ...
    public void setEnd(Pos end){
        ...
        while (endPoint == null || !isNode(endPoint)){
            endPoint = new Pos(
                    World.getRandomInt(end.getCellX() - 3, end.getCellX() + 3), 
                    World.getRandomInt(end.getCellY() - 3, end.getCellY() + 3));
