...
public class XSound extends ManagedSound {
     ...
     */
    public XSound(URL url, String description) throws Exception {
        this(Soundly.loadSound(url), description);
    }

    public XSound(String ref, InputStream in) throws Exception {
     ...
     * @throws SlickException
     */
    public XSound(URL url) throws Exception {
     ...
     * @throws SlickException
     */
    public XSound(String ref, String description) throws Exception {
     ...
     * @throws SlickException
     */
    public XSound(String ref) throws Exception {
        this(ref, ref);
    }
    ...
    protected void updateOpenAL(int source, int sourceIndex, int delta, boolean init) {
        ...
        double volume = mixedVolume() * GLOBAL_MIX.getVolume();
        float pitch = mixedPitch() * GLOBAL_MIX.getPitch();
        double x = mixedX() + GLOBAL_MIX.getXAdjustment();
        double y = mixedY() + GLOBAL_MIX.getYAdjustment();
        double depth = mixedDepth() + GLOBAL_MIX.getDepthAdjustment();
    ...
    public int queueAtIndex(int sourceIndex) {
        ...
        if (getSourceIndex() != -1 && Soundly.isSourcePlaying(getSource())) {
            stop();
