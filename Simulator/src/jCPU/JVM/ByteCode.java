...
public class ByteCode implements jx.zero.ByteCode {
    ...
    static Function<CPU, Integer> op_aload_0 = cpu -> cpu.handler.op_aload_0();
    static Function<CPU, Integer> op_bipush = cpu -> cpu.handler.op_bipush(cpu.opCode);
    static Function<CPU, Integer> op_dup = cpu -> cpu.handler.op_dup(), 
