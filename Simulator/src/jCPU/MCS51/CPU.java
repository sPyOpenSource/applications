...
import jCPU.MCS51.graph.Arithmetic;
import jCPU.MCS51.graph.ArithmeticOperation;
import jCPU.MCS51.graph.AsyncTimer;
import jCPU.MCS51.graph.inst.*;
 ...
 *	
 */
public class CPU implements MCS51Constants, jCPU.iCPU
{
	 ...
	 * @since 1.04
	 */
	static private CPU current = null;
	...
	public CPU(int osc, int numSfrPage)
	{
