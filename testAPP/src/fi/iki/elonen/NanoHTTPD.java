...
public class NanoHTTPD {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(NanoHTTPD.class.getName()).log(Level.SEVERE, null, ioe);
            System.exit(-1);
        }
        ...
        public void run() {
            try {
                ...
                try {
                    ...
                    Logger.getLogger(NanoHTTPD.class.getName()).log(Level.SEVERE, null, t);
                }
            ...
            if (range != null) {
                if (range.startsWith("bytes=")) {
                    ...
                    try {
                        ...
                        Logger.getLogger(NanoHTTPD.class.getName()).log(Level.SEVERE, null, nfe);
                    }
                }
            }
