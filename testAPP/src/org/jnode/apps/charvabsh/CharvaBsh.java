        ...
        void showSaveDialog() {
            ...
            if (s == null) {
                ...
                try {
                    ...
                    Logger.getLogger(CharvaBsh.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
...
//            BSHOutputAdapter out = new BSHOutputAdapter(output);
        ...
        private void addMenuBar() {
            ...
            exit.addActionListener((ActionEvent ae_) -> {
                done();
            });

            JMenuItem loadItem = new JMenuItem("Load");
            loadItem.addActionListener((ActionEvent ae_) -> {
                showLoadDialog();
            });
            JMenuItem saveItem = new JMenuItem("Save");
            saveItem.addActionListener((ActionEvent ae_) -> {
                showSaveDialog();
            });

            JMenuItem eval = new JMenuItem("Evaluate");
            eval.addActionListener((ActionEvent ae_) -> {
                evaluateText();
                repaint();
            });
