...
public abstract class PropertiesPanel extends ListPanel {
    ...
    public void fillPanel(Object rootObject) {
        ...
        final Vector<ListElement> list = new Vector<>();
        ...
        while (parent != null) {
            ...
            for (Field field : fields) {
                list.addElement(new ListElement(new ObjectFieldPair(rootObject, field), //" "+fields[i].getType()+
                        " " + field.getName()));
        ...
        while (parent != null) {
            ...
            for (Method method : methods) {
                String label = method.getReturnType().getName() + " " + method.getName() + "(";
                ...
                label += ")";
                list.addElement(new ListElement(new ObjectMethodPair(rootObject, method), label));
