 ...
 */
public final class BootSector extends NTFSStructure {
    ...
    public BootSector(Memory buffer) {
        super(buffer, 0);
        this.systemID = getString(0x03, 8);
        ...
        this.serialNumber = String.format("%02X%02X-%02X%02X", 
                buffer.get8(0x4b), buffer.get8(0x4a), buffer.get8(0x49), buffer.get8(0x48));
