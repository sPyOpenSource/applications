...
MemoryManager MemManager;
     ...
     */
    public LogClientRecord(Memory buffer, int offset) {
        super(buffer, offset);
    }
    ...
    public String toDebugString() {
        ...
        builder.append("oldest-lsn: ").append(getOldestLsn()).append("\n");
        builder.append("restart-lsn: ").append(getRestartLsn()).append("\n");
        builder.append("previous-client: ").append(getPreviousClientOffset()).append("\n");
        builder.append("next-client: ").append(getNextClientOffset()).append("\n");
        builder.append("sequence-number: ").append(getSequenceNumber()).append("\n");
        builder.append("name-length: ").append(getClientNameLength()).append("\n");
        builder.append("name: ").append(getClientName()).append("]");
