...
public class LogRecord extends NTFSStructure {
     ...
     */
    public LogRecord(Memory buffer, int offset, int pageSize, int logPageDataOffset) {
        super(buffer, offset);
     ...
     */
    public final void getDataAcrossPages(int offset, Memory dst, int dstOffset, int length) {
        if (getCrossesPage()) {
     ...
     */
    public void getRedoData(Memory buffer) {
     ...
     * @param buffer the buffer to write into.
     */
    public void getUndoData(Memory buffer) {
