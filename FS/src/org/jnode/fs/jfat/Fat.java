...
public abstract class Fat {
    ...
    public void readCluster(int cluster, int offset, Memory dst) throws IOException {
        if (offset < 0) {
    ...
    public abstract int getClusterPosition(int index);
   ...
   /* public String toDebugString() {
    ...
    public void allocAppend(long startCluster) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
